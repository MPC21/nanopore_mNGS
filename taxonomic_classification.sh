...
# taxonomic classification from long read metagenomics sequencing data
...
taxor search --index-file reference/refseq/refseq-abfv-k22-s12.hixf \
--query-file $SAMPLE.fastq.gz --output-file taxor_result/${SAMPLE}_search.txt \
